      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg sm:text-xl font-semibold text-indigo-700">Article Configuration</h1>
          </div>
        ...
        <div className="w-full lg:w-1/2 bg-white p-4 sm:p-6 rounded-xl shadow-md border border-gray-200">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h1 className="text-lg sm:text-xl font-semibold text-indigo-700">Generated Article</h1>
          </div>
